return {
  {
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        json = { "biome-check", "prettierd", "prettier", "oxfmt", stop_after_first = true },
        jsonc = { "biome-check", "prettierd", "prettier", "oxfmt", stop_after_first = true },
        css = { "biome-check", "prettierd", "prettier", "oxfmt", stop_after_first = true },
